  ...
  (setq-default
   ...
   '(
     ...
     (c-c++ :variables
            ...
            c-c++-lsp-executable (file-truename "/usr/local/opt/llvm/bin/clangd"))
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-startup-banner '"~/.spacemacs.d/ue-colorful.png"
...
before packages are loaded."
  ...
  (setq-default org-agenda-dir  "~/.spacemacs.d/gtd/")
  (setq org-agenda-files '("~/.spacemacs.d/gtd"))
  (setq org-todo-keywords '((sequence "[STUDY](s)" "[TODO](t)" "[WAIT](w!))" "|" "[DONE](d!/@)" "[CACELED](c!@)")
   ...
   (setq org-babel-load-languages
    '((python . t) (shell . t) (emacs-lisp . t) (C . t)))
  )
